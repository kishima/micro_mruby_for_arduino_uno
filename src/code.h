...
0x65,0x73,0x74,0x00,0x00,0x06,0x48,0x65,0x6C,0x6C,0x6F,0x21,0x20,0x0D,0x01,
};
...
0x01,0x80,0x00,0xA0,0x01,0x80,0x00,0x29,0x0D,
};
...
/* Symbol table */
const unsigned char mmruby_code_symbol_table_size PROGMEM = 36;
...
const char mmruby_code_symbol_ref20[] PROGMEM ="method";
const char mmruby_code_symbol_ref21[] PROGMEM ="pin_mode";
const char mmruby_code_symbol_ref22[] PROGMEM ="digital_write";
const char mmruby_code_symbol_ref23[] PROGMEM ="digital_read";
